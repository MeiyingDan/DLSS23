...
class Conv():
    def __init__(self, stride_shape, convolution_shape, num_kernels):
        ...
        self.conv2d = (len(convolution_shape) == 3)     # judgment dimension of kernel
    ...
    def forward(self, input_tensor):
        ...
        if self.convolution_shape[1] // 2 == 0 and self.convolution_shape[2] // 2 == 0:    # Judging odd and even numbers
        ...
        # loop through the number of batch size
